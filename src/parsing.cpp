...
{
    if (line.find("NICK") == 0 || line.find("USER") == 0 || line.find("PASS") == 0 || line.find("OPER") == 0 || line.find("PRIVMSG") == 0 || line.find("JOIN") == 0 || line.find("PING") == 0 || line.find("PONG") == 0 || line.find("TOPIC") == 0 || line.find("KICK") == 0 || line.find("MODE") == 0 || line.find("PART") == 0 || line.find("QUIT") == 0 || line.find("INVITE") == 0)
        return true;
    return false;
}
